  ...
  return (
    <div className="flex h-screen bg-slate-100 text-slate-800 font-sans relative">
      ...
      <ChatHistory
        ...
        className={`absolute md:relative z-30 h-full w-64 shrink-0 transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}
        isLoading={isLoading}
      />
